 ...
 * Use the [ChainSpreadFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ChainSpreadFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_chain_spread, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ChainSpreadFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ChainSpreadFragment().apply {
