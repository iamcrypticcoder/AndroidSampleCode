...
import com.iamcrypticcoder.androidservicernd.service.*
import com.iamcrypticcoder.androidservicernd.service.LocalService.LocalBinder
...
class BindingActivity : AppCompatActivity() {
    ...
    private val mLocalServiceConnection: ServiceConnection = object : ServiceConnection {
        override fun onServiceConnected(className: ComponentName, service: IBinder) {
            ...
            randomNumberButton1.isEnabled = true;
            doLongTask1.isEnabled = true
        }
        override fun onServiceDisconnected(className: ComponentName) {
            Toast.makeText(this@BindingActivity, R.string.local_service_disconnected, Toast.LENGTH_SHORT).show()
            randomNumberButton1.isEnabled = false;
            doLongTask1.isEnabled = false
        }
    }
    ...
    private val mLocalMessengerServiceConnection : ServiceConnection = object : ServiceConnection {
        override fun onServiceConnected(className: ComponentName, service: IBinder) {
            ...
            randomNumberButton2.isEnabled = true;
            doLongTask2.isEnabled = true
        ...
        override fun onServiceDisconnected(className: ComponentName) {
            ...
            randomNumberButton2.isEnabled = false;
            doLongTask2.isEnabled = false
        }
    }
    ...
    private fun setupLocalServiceDemo() {
        ...
        randomNumberButton1.setOnClickListener {
        ...
        doLongTask1.setOnClickListener {

        }
    }

    private fun setupLocalMessengerServiceDemo() {
        bindButton2.setOnClickListener {
            bindLocalMessengerService()
        }
        unbindButton2.setOnClickListener {
            unbindLocalMessengerService()
        }
        randomNumberButton2.setOnClickListener {
        ...
        doLongTask2.setOnClickListener {
