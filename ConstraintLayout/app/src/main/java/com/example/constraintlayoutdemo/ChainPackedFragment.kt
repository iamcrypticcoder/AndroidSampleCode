...
import kotlinx.android.synthetic.main.fragment_chain_packed.*
import kotlinx.android.synthetic.main.fragment_chain_packed.addImageButton
import kotlinx.android.synthetic.main.fragment_chain_packed.contentView
import kotlinx.android.synthetic.main.fragment_chain_packed.imageView1
import kotlinx.android.synthetic.main.fragment_chain_packed.removeImageButton
import kotlinx.android.synthetic.main.fragment_chain_packed.switchImageRatio
 ...
 * Use the [ChainPackedFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ChainPackedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_chain_packed, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        biasSeekBar.progress = 50
        biasSeekBar.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            ...
            override fun onStopTrackingTouch(seekBar: SeekBar?) {
                ...
                set.clone(contentView);
                set.setHorizontalBias(imageView1.id, (seekBar?.progress!! / 100.0).toFloat())
                TransitionManager.beginDelayedTransition(contentView)
                set.applyTo(contentView)
            }
    ...
    companion object {
         ...
         * @return A new instance of fragment ChainPackedFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ChainPackedFragment().apply {
